package com.poethan.jear.aspect;

import com.poethan.jear.anno.EzApiCache;
import com.poethan.jear.module.cache.EzLocalCache;
...
public class EzApiCacheAspect {
    ...
    @Pointcut("@annotation(com.poethan.jear.anno.EzApiCache)")
